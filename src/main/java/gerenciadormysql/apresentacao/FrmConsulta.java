...
public class FrmConsulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtarQuery.setText("SELECT C3.CIDADE_ID AS \"CIDADE\", C.NOME AS \"CATEGORIA\", COUNT(C.CATEGORIA_ID) AS \"LOCAÇÕES\"\nFROM CATEGORIA C JOIN FILME_CATEGORIA FA ON C.CATEGORIA_ID = FA.CATEGORIA_ID\nJOIN FILME F ON F.FILME_ID = FA.FILME_ID\nJOIN INVENTARIO I ON I.FILME_ID = F.FILME_ID\nJOIN ALUGUEL A ON I.INVENTARIO_ID = A.INVENTARIO_ID\nJOIN CLIENTE C2 ON A.CLIENTE_ID = C2.CLIENTE_ID\nJOIN ENDERECO E ON C2.ENDERECO_ID = E.ENDERECO_ID\nJOIN CIDADE C3 ON E.CIDADE_ID = C3.CIDADE_ID\nWHERE A.DATA_ALUGUEL BETWEEN \"2001-01-01\" AND \"2021-12-31\"\nGROUP BY C3.CIDADE_ID, C.NOME\nORDER BY 1 DESC");
